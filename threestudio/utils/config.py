...
class ExperimentConfig:
    ...
    def __post_init__(self):
        ...
        if os.path.exists(os.path.join(self.data.image_path, "masks/sam")):
            self.trial_dir = os.path.join(self.exp_dir, os.path.basename(os.path.dirname(os.path.dirname(self.data.image_path)))) # change to id name
        else:
            self.trial_dir = os.path.join(self.exp_dir, os.path.basename(self.data.image_path)) # change to id name

...
# load model
def load_model_from_config(config, ckpt, device, vram_O=True, verbose=True):
...
@threestudio.register("v123-guidance")
class V123Guidance(BaseObject):
    @dataclass
    ...
    def configure(self) -> None:
        threestudio.info(f"Loading V123 ...")
        ...
        threestudio.info(f"Loaded V123!")
